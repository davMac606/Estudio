    ...
    class Modalidade
    {
        ...
        public bool cadastrarModalidade()
        {
            ...
            try
            {
                ...
                MySqlCommand insere = new MySqlCommand("insert into ModalCS (idModal, descModal, precoModal, qtdAlModal, qtdAuModal, ativa) values ('" + Id_Modal + "','" + Desc + "','" + Preco + "','" + Qtd_Alunos + "','" + Qtd_Aulas + "','" + 0 + "')", DAO_Conexao.con);
